...
DATA.chapter1 = {
  ...
  // ---------------------------------------------------------------------------
  // shards — 5개 (core×3 + echo×1 + false×1). 모두 floor 위, 충돌/가구와 비겹침.
  //
  //   좌표 검산 (collision/가구 사각형 안에 들어가지 않음을 직접 확인):
  //   ┌──────────────────────────┬─────────┬──────────────────────────────────┐
  //   │ shard                     │ tile    │ 판정                              │
  //   ├──────────────────────────┼─────────┼──────────────────────────────────┤
  //   │ core 이름표 목걸이        │ [9,5]   │ FREE — 게임기(9~10,3~4) 바로 아래 │
  //   │ core 빛바랜 사진          │ [16,5]  │ FREE — 책상(15~19,3~4) 바로 아래   │
  //   │ core 일기장 한 페이지     │ [4,6]   │ FREE — 침대(2~5,8~11) 위쪽, 충돌밖 │
  //   │ echo 창틀 발톱 자국       │ [20,12] │ FREE — 옷장(17~19,9~11) 피해 우하단│
  //   │ false 하루가 손 흔든다    │ [13,11] │ FREE — 방 중앙 하단, 충돌밖        │
  //   └──────────────────────────┴─────────┴──────────────────────────────────┘
  //   (검산 스크립트로 전 좌표 collision 비겹침 확인 완료.)
  //
